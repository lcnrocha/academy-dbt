with
    ...
    , joining_tables as (
        select
            row_number() over(order by sales_order_detail.sales_order_detail_sales_order_id,
                                       ...
                                       sales_order_detail.sales_order_detail_product_id) as sales_order_detail_sales_order_item_sk
